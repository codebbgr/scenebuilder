...
public class EditorPlatform {
  ...
  private static final String osName =
      System.getProperty("os.name").toLowerCase(Locale.ROOT); // NOI18N
  ...
  public static final String DOCUMENTATION_URL =
      "https://docs.oracle.com/javafx/index.html"; // NOI18N

  /** Javadoc home (for Inspector and CSS Analyzer properties) */
  public static final String JAVADOC_HOME = "https://openjfx.io/javadoc/11/"; // NOI18N

  /** Gluon javadoc home (for Inspector and CSS Analyzer properties) */
  public static final String GLUON_JAVADOC_HOME =
      "http://docs.gluonhq.com/charm/javadoc/" + "latest" + "/"; // NOI18N

  /** scene builder specific tweaks to Gluon theme */
  public static final String GLUON_DOCUMENT_STYLESHEET =
  ...
  public enum Theme implements StylesheetProvider {
    ...
    MODENA_HIGH_CONTRAST_BLACK_ON_WHITE(
        "com/oracle/javafx/scenebuilder/kit/util/css/modena/modena-highContrast-blackOnWhite.css"),
    MODENA_HIGH_CONTRAST_WHITE_ON_BLACK(
        "com/oracle/javafx/scenebuilder/kit/util/css/modena/modena-highContrast-whiteOnBlack.css"),
    MODENA_HIGH_CONTRAST_YELLOW_ON_BLACK(
        "com/oracle/javafx/scenebuilder/kit/util/css/modena/modena-highContrast-yellowOnBlack.css"),
    MODENA_TOUCH_HIGH_CONTRAST_BLACK_ON_WHITE(
        "com/oracle/javafx/scenebuilder/kit/util/css/modena/modena-touch-highContrast-blackOnWhite.css"),
    MODENA_TOUCH_HIGH_CONTRAST_WHITE_ON_BLACK(
        "com/oracle/javafx/scenebuilder/kit/util/css/modena/modena-touch-highContrast-whiteOnBlack.css"),
    MODENA_TOUCH_HIGH_CONTRAST_YELLOW_ON_BLACK(
        "com/oracle/javafx/scenebuilder/kit/util/css/modena/modena-touch-highContrast-yellowOnBlack.css"),
    CASPIAN("com/sun/javafx/scene/control/skin/caspian/caspian.bss"),
    CASPIAN_HIGH_CONTRAST(
        "com/oracle/javafx/scenebuilder/kit/util/css/caspian/caspian-highContrast.css"),
  ...
  public enum GluonSwatch implements StylesheetProvider {
    ...
    @Override
    public String getStylesheetURL() {
      return GlistenStyleClasses.impl_loadResource(
          "swatch_" + name().toLowerCase(Locale.ROOT) + ".gls");
    }
              ...
              if (indexOf != -1) {
                ...
                String colorString =
                    trimmedString.substring(
                        indexOf + PRIMARY_SWATCH_500_STR.length(), indexOfSemiColon);
  ...
  /**
   * Requests the underlying platform to open a given file. On Linux, it runs 'xdg-open'. On Mac, it
   * runs 'open'. On Windows, it runs 'cmd /c start'.
   *
  ...
  /**
   * Requests the underlying platform to "reveal" the specified folder. On Linux, it runs
   * 'nautilus'. On Mac, it runs 'open'. On Windows, it runs 'explorer /select'.
   *
  ...
  public static void revealInFileBrowser(File filePath) throws IOException {
    ...
    if (EditorPlatform.IS_MAC) {
      ...
      int osVersionNumerical =
          Integer.parseInt(System.getProperty("os.version").substring(0, 1)); // NOI18N
