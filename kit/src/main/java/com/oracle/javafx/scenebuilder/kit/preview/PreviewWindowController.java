...
public final class PreviewWindowController extends AbstractWindowController {
  ...
  public PreviewWindowController(EditorController editorController, Stage owner) {
    ...
    this.editorController
        .resourcesProperty()
        .addListener((ChangeListener<ResourceBundle>) (ov, t, t1) -> requestUpdate(DELAYED));
    this.editorController
        .sampleDataEnabledProperty()
  ...
  public void openDialog() {
    ...
    try {
      clone =
          new FXOMDocument(
              fxomDocument.getFxmlText(false),
  ...
  /**
   * We use the provided delay before refreshing the content of the preview. If further modification
   * is brought to the layout before expiration of it we restart the timer. The idea is to lower the
   * resources used to refresh the preview window content. The delay is expressed in milliseconds.
                  ...
                  if (fxomDocument != null) {
                    ...
                    try {
                      ...
                      throw new RuntimeException(
                          "Bug in PreviewWindowController::requestUpdate", ex); // NOI18N
                    }
                    ...
                    if (sceneGraphRoot instanceof Parent) {
                      ...
                      computeStyleSheets(
                          newStyleSheets1, sceneGraphRoot, clone.getDisplayStylesheets());
                      ...
                      computeStyleSheets(
                          newStyleSheets2, sceneGraphRoot, clone.getDisplayStylesheets());
   ...
   *
   * @param autoResize3DContent true if this preview panel should autoresize 3D content.
   */
  ...
  private void computeStyleSheets(
      List<String> newStyleSheets, Object sceneGraphRoot, List<String> displayStylesheets) {
    if (sceneGraphRoot instanceof Parent) {
