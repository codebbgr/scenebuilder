...
/**
 * Utility which offers a map with pairs of even type names and corresponding event names. Event
...
public class FindEventNamesUtil {
  ...
  /**
   * Gets the event name to the given event type name. If no event name was found, a default value
   * (ActionEvent) is returned.
   *
