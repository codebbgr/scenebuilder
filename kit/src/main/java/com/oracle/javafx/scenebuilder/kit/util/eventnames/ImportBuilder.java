...
public class ImportBuilder {
  ...
  /**
   * Builds a new import statement. The key may be the "import" keyword, or the "import" keyword
   * combined with a "javafx.scene.input." package name. The value may be a full class name (e.g.
   * with package) or an input event name.
   *
