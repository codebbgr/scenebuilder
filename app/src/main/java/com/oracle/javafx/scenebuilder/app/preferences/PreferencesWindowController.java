...
public class PreferencesWindowController extends AbstractFxmlWindowController {
  ...
  @FXML private DoubleField rootContainerHeight;
  @FXML private DoubleField rootContainerWidth;
  @FXML private ChoiceBox<BackgroundImage> backgroundImage;
  @FXML private ChoiceBox<ToolTheme> scenebuilderTheme;
  @FXML private ChoiceBox<DISPLAY_MODE> libraryDisplayOption;
  @FXML private ChoiceBox<DisplayOption> hierarchyDisplayOption;
  @FXML private ChoiceBox<CSSAnalyzerColumnsOrder> cssAnalyzerColumnsOrder;
  @FXML private MenuButton alignmentGuidesButton;
  @FXML private MenuButton parentRingButton;
  @FXML private CustomMenuItem alignmentGuidesMenuItem;
  @FXML private CustomMenuItem parentRingMenuItem;
  @FXML private Rectangle alignmentGuidesGraphic;
  @FXML private Rectangle parentRingGraphic;
  @FXML private ChoiceBox<Integer> recentItemsSize;
  @FXML private ChoiceBox<EditorPlatform.Theme> themes;
  @FXML private CheckBox animateAccordion;
  @FXML private CheckBox wildcardImports;
  ...
  public PreferencesWindowController(Stage ownerWindow) {
    super(
        PreferencesWindowController.class.getResource("Preferences.fxml"), // NOI18N
        I18N.getBundle(),
        ownerWindow);
  ...
  protected void controllerDidLoadFxml() {
    ...
    rootContainerHeight.setOnAction(
        t -> {
          ...
          SceneBuilderApp.applyToAllDocumentWindows(
              dwc -> dwc.refreshRootContainerHeight(recordGlobal));
        });
    rootContainerWidth.setText(String.valueOf(recordGlobal.getRootContainerWidth()));
    rootContainerWidth.setOnAction(
        t -> {
          ...
          SceneBuilderApp.applyToAllDocumentWindows(
              dwc -> dwc.refreshRootContainerWidth(recordGlobal));
        });
    ...
    backgroundImage
        ...
        .addListener(new BackgroundImageListener());
    ...
    alignmentColorPicker
        .paintProperty()
        .addListener(new AlignmentGuidesColorListener(alignmentGuidesGraphic));
    ...
    parentRingColorPicker
        .paintProperty()
        .addListener(new ParentRingColorListener(parentRingGraphic));
    ...
    scenebuilderTheme
        .getSelectionModel()
        .selectedItemProperty()
        .addListener(new ToolThemeListener());

    // Library view option
    final DISPLAY_MODE availableDisplayMode[] =
        new DISPLAY_MODE[] {DISPLAY_MODE.LIST, DISPLAY_MODE.SECTIONS};
    ...
    libraryDisplayOption
        .getSelectionModel()
        .selectedItemProperty()
        .addListener(new LibraryOptionListener());
    ...
    hierarchyDisplayOption
        .getSelectionModel()
        .selectedItemProperty()
        .addListener(new DisplayOptionListener());

    // CSS analyzer column order
    cssAnalyzerColumnsOrder
        .getItems()
        .setAll(Arrays.asList(CSSAnalyzerColumnsOrder.class.getEnumConstants()));
    cssAnalyzerColumnsOrder.setValue(recordGlobal.getCSSAnalyzerColumnsOrder());
    cssAnalyzerColumnsOrder
        .getSelectionModel()
        .selectedItemProperty()
        .addListener(new ColumnOrderListener());
    ...
    recentItemsSize
        .getSelectionModel()
        .selectedItemProperty()
        .addListener(new RecentItemsSizeListener());
  ...
  private static class BackgroundImageListener implements ChangeListener<BackgroundImage> {
    ...
    @Override
    public void changed(
        ObservableValue<? extends BackgroundImage> observable,
        BackgroundImage oldValue,
  ...
  private static class ToolThemeListener implements ChangeListener<ToolTheme> {
    ...
    @Override
    public void changed(
        ObservableValue<? extends ToolTheme> observable, ToolTheme oldValue, ToolTheme newValue) {
      final PreferencesController preferencesController = PreferencesController.getSingleton();
      final PreferencesRecordGlobal recordGlobal = preferencesController.getRecordGlobal();
      // Update preferences
  ...
  private static class LibraryOptionListener implements ChangeListener<DISPLAY_MODE> {
    ...
    @Override
    public void changed(
        ObservableValue<? extends DISPLAY_MODE> ov, DISPLAY_MODE oldValue, DISPLAY_MODE newValue) {
      final PreferencesController preferencesController = PreferencesController.getSingleton();
      final PreferencesRecordGlobal recordGlobal = preferencesController.getRecordGlobal();
      // Update preferences
      ...
      SceneBuilderApp.applyToAllDocumentWindows(
          dwc -> dwc.refreshLibraryDisplayOption(recordGlobal));
    }
  }
  ...
  private static class DisplayOptionListener implements ChangeListener<DisplayOption> {
    ...
    @Override
    public void changed(
        ObservableValue<? extends DisplayOption> observable,
      ...
      SceneBuilderApp.applyToAllDocumentWindows(
          dwc -> dwc.refreshHierarchyDisplayOption(recordGlobal));
    }
  }
  ...
  private static class ColumnOrderListener implements ChangeListener<CSSAnalyzerColumnsOrder> {
    ...
    @Override
    public void changed(
        ObservableValue<? extends CSSAnalyzerColumnsOrder> observable,
      ...
      SceneBuilderApp.applyToAllDocumentWindows(
          dwc -> dwc.refreshCssTableColumnsOrderingReversed(recordGlobal));
    }
  }
  ...
  private static class ThemesListener implements ChangeListener<EditorPlatform.Theme> {
    @Override
    public void changed(
        ObservableValue<? extends EditorPlatform.Theme> observable,
        EditorPlatform.Theme oldValue,
        EditorPlatform.Theme newValue) {
      final PreferencesController preferencesController = PreferencesController.getSingleton();
      final PreferencesRecordGlobal recordGlobal = preferencesController.getRecordGlobal();
      // Update preferences
  ...
  private static class AlignmentGuidesColorListener implements ChangeListener<Paint> {
    ...
    public void changed(ObservableValue<? extends Paint> ov, Paint oldValue, Paint newValue) {
      ...
      SceneBuilderApp.applyToAllDocumentWindows(
          dwc -> dwc.refreshAlignmentGuidesColor(recordGlobal));
